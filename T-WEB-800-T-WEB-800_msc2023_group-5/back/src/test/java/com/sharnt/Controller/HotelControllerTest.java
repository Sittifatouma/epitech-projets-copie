...
import com.sharnt.controller.HotelController;
...
/**
 * Method to test {@link HotelController}
 *
 *
 */
...
public class HotelControllerTest {
    ...
    public void shouldReturn_ListTrip() throws Exception {
        mockMvc.perform(get("/hotel?bl_latitude=48.856&tr_latitude=2.352&bl_longitude=2.553&tr_longitude=49.857").header("Origin", " ")).andExpect(status().is2xxSuccessful())
