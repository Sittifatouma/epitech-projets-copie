...
public class ActivityController {
    ...
    String  displayString() {
        System.out.println("activity test route start");
        return "connection react / java works !";
    }
    ...
    List<Trip> fetch(@Valid String bl_latitude,@Valid String tr_latitude,@Valid String bl_longitude,@Valid String tr_longitude) throws IOException, UnirestException {
        ...
        sb.append("https://travel-advisor.p.rapidapi.com/attractions/list-in-boundary?bl_latitude=");
         ...
         * Call the Url
         */
         HttpResponse<String> response2 = Unirest.get(urlApi)
                .header("X-RapidAPI-Key", "6d491c9c48msh30e5abb72a551f4p13e118jsn6e1074011151")
