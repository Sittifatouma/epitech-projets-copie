...
policyList = ['greedy','randomPolicy','epsilon_greedy', 'softmax']
...
for policy in policyList:
  for epoch_number in np.linspace(mail["training_number"]["start"], mail["training_number"]["end"], mail["training_number"]["steps"]):
    ...
    # Learning QSA with Q-learning algorithme 
    q_sa = Q_learning_policy(environment, epsilon, alpha, gamma, int(epoch_number), policy, 0.1, True)
